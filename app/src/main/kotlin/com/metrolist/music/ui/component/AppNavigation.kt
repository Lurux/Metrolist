...
@Stable
private fun isRouteSelected(currentRoute: String?, screenRoute: String, navigationItems: List<NavigationScreens>): Boolean {
...
fun AppNavigationRail(
    navigationItems: List<NavigationScreens>,
    currentRoute: String?,
    onItemClick: (NavigationScreens, Boolean) -> Unit,
    ...
    NavigationRail(
        ...
        navigationItems.forEach { screen ->
            ...
            val isSearchItem = screen == NavigationScreens.SEARCH && onSearchLongClick != null
